...
✅ Display file data on the console

✅ Uses simple and beginner-friendly syntax
...
A file named example.txt will be created automatically.

The program writes data into the file.

Then it reads the same file.
...
✔️ How to write data into files

✔️ How to read data from files

✔️ Importance of closing files

✔️ Using with open() for safe file handling

✔️ Organizing a project for GitHub
